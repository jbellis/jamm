...
This directory contains the configuration for CircleCI continuous integration platform.
The file `config.yml` is the configuration file that is read by CircleCI. This file is
automatically generated by the `config_template.yml` file.
...
regenerate the `config.yml` by running:
   `circleci config process config_template.yml > config.yml`
